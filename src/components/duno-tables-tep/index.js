      ...
      render: (h, params) => {
        ...
        if (that.isView) {
          newArr.push(h('el-tooltip', {
            props: { content: '查看' }
              ...
              h('el-button', {
                class:'tableBtnName', style: {backgroundImage:'url('+ this.lookBtn +')'},
        ...
        if (that.isEdit) {
          newArr.push(h('el-tooltip', {
            props: { content: '编辑' }
              ...
              h('el-button', {
                class:'tableBtnName', style: {backgroundImage:'url('+ this.editBtn +')'},
        ...
        if (that.isDel) {
          newArr.push(h('el-tooltip', {
              ...
              }, [ h('el-button', { class:'tableBtnName', style: {backgroundImage:'url('+ this.delBtn +')'} }) ])
          ]))
        }
        return h('div', newArr)
      }
